    ...
    return (
        <div className="login-wrapper">
            <form className="form">
                ...
                <div className="btn">
                    <button className="button1" onClick={handleSignUp} data-testid="signup-button">Crear Cuenta</button>
                </div>
                <button className="button2" onClick={handleBackToLogin} data-testid="login-button">Volver a Inicio Sesión</button>
            </form>
        </div>
    );
}
